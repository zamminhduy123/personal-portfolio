...
import dmText from '@static/dm3.png'
      ...
      >
          ...
          <article className="w-full h-fit flex flex-col items-center justify-center bg-black">
              ...
              >
                  ...
                  <div className="col-start-6 col-end-10 bg-white row-start-1 row-end-8 rounded-xl flex justify-center items-center relative">
              ...
              <div
                  ...
                  style={{ height: "110svh" }}
              >
                  <div className="col-start-2 col-end-7 row-start-1 row-end-6 bg-red-400 rounded-xl overflow-hidden relative flex justify-center ">
                      <div
                          className={clsx(
                              "w-full",
                              "h-full",
